...
namespace _213.Forms
{
    public partial class FormMoney : Form
    {
            ...
            public void InsertStaff(TextBox textBox1, TextBox textBox2, TextBox textBox3, TextBox textBox4)
            {
                ...
                if (textBox1.Text.Length > 0)
                {
                    ...
                    try
                    {
                        ...
                        MessageBox.Show("Добавление записи прошло успешно", "Информация", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void радарToolStripMenuItem_Click(object sender, EventArgs e)
        {
            chart1.Series["SC1"].ChartType = SeriesChartType.Polar;
            chart2.Series["SC2"].ChartType = SeriesChartType.Polar;
        }
        ...
        private void кагиДиаграммаToolStripMenuItem_Click(object sender, EventArgs e)
        {
            chart1.Series["SC1"].ChartType = SeriesChartType.Kagi;
            chart2.Series["SC2"].ChartType = SeriesChartType.Kagi;
        }
        ...
        private void поинтДиаграммаToolStripMenuItem_Click(object sender, EventArgs e)
        {
            chart1.Series["SC1"].ChartType = SeriesChartType.Point;
            chart2.Series["SC2"].ChartType = SeriesChartType.Point;
        }

        private void доходыToolStripMenuItem2_Click(object sender, EventArgs e)
        {
            chart1.Series["SC1"].ChartType = SeriesChartType.Point;
        }

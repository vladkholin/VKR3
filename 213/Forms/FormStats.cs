...
namespace _213.Forms
{
    public partial class FormStats : Form
    {
        ...
        private void ареаДиаграммаToolStripMenuItem_Click(object sender, EventArgs e)
        {
            chart1.Series["Sales"].ChartType = SeriesChartType.Area;
        }

        private void барДиаграммаToolStripMenuItem_Click(object sender, EventArgs e)
        {
            chart1.Series["Sales"].ChartType = SeriesChartType.Bar;
        }

        private void линейнаяДиагрммаToolStripMenuItem_Click(object sender, EventArgs e)
        {
            chart1.Series["Sales"].ChartType = SeriesChartType.Line;
        }

        private void диаграммаОбластиToolStripMenuItem_Click(object sender, EventArgs e)
        {
            chart1.Series["Sales"].ChartType = SeriesChartType.Area;
        }
